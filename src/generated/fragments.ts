...
export type AddSubIssuesInput = {
  childIssueIds: Array<Scalars['ID']['input']>;
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
...
export type AddSubIssuesPayload = {
  __typename?: 'AddSubIssuesPayload';
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  failedIssues: Array<Issue>;
  githubErrors: Scalars['JSON']['output'];
...
export type BaseIssueType = {
  ...
  disposition: IssueTypeDisposition;
  id: Scalars['ID']['output'];
  isDefault: Scalars['Boolean']['output'];
  isDefaultForLevel: Scalars['Boolean']['output'];
...
export type CreateIssueInput = {
  ...
  zenhubAssigneeIds?: InputMaybe<Array<Scalars['ID']['input']>>;
  /** Label infos for Zenhub issue */
  zenhubLabelInfos?: InputMaybe<Array<LabelInfoInput>>;
  zorgMetadata?: InputMaybe<ZorgIssueMetadataInput>;
};
...
export type CreateIssueKeyDatePayload = {
  __typename?: 'CreateIssueKeyDatePayload';
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  issue: Issue;
  keyDate: KeyDate;
...
export type CreateTimelineKeyDatePayload = {
  __typename?: 'CreateTimelineKeyDatePayload';
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  keyDate: KeyDate;
  workspace: Workspace;
...
export type DeleteIssueKeyDatePayload = {
  __typename?: 'DeleteIssueKeyDatePayload';
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  issue: Issue;
  keyDate: KeyDate;
...
export type DeleteMilestoneInput = {
  ...
  milestoneId: Scalars['ID']['input'];
  updateAllInWorkspaceId?: InputMaybe<Scalars['ID']['input']>;
};
...
export type DeleteTimelineKeyDatePayload = {
  __typename?: 'DeleteTimelineKeyDatePayload';
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  keyDate: KeyDate;
  workspace: Workspace;
...
export type DeliveryRiskFilterInput = {
  progressKind?: InputMaybe<DeliveryRiskProgressKind>;
  recursive?: InputMaybe<Scalars['Boolean']['input']>;
  scopeToWorkspace?: InputMaybe<Scalars['Boolean']['input']>;
  statuses?: InputMaybe<DeliveryRiskStatusInput>;
};

export enum DeliveryRiskProgressKind {
...
export enum DeliveryRiskStatus {
...
export type DeliveryRiskStatusInput = {
  in?: InputMaybe<Array<DeliveryRiskStatus>>;
  nin?: InputMaybe<Array<DeliveryRiskStatus>>;
};
...
export type GithubIssueTypeConnection = {
  __typename?: 'GithubIssueTypeConnection';
  /** A list of edges. */
  edges: Array<GithubIssueTypeEdge>;
  /** A list of nodes. */
  nodes: Array<GithubIssueType>;
  /** Information to aid in pagination. */
  pageInfo: PageInfo;
  totalCount: Scalars['Int']['output'];
};
...
export type GithubIssueTypeEdge = {
  __typename?: 'GithubIssueTypeEdge';
  /** A cursor for use in pagination. */
  cursor: Scalars['String']['output'];
  /** The item at the end of the edge. */
  node: GithubIssueType;
};
...
export type Issue = ActivityFeedField & GithubTimestamps & Node & Timestamps & ViewerPermission & {
  ...
  enteredStageAt?: Maybe<Scalars['ISO8601DateTime']['output']>;
  ...
  githubChildIssues: IssueConnection;
  /** Parent issue of this Issue. */
  githubParentIssue?: Maybe<Issue>;
  htmlBody?: Maybe<Scalars['String']['output']>;
  htmlUrl: Scalars['String']['output'];
  id: Scalars['ID']['output'];
  issueType?: Maybe<IssueIssueType>;
  ...
  zenhubChildIssues: IssueConnection;
  zenhubLabels: ZenhubLabelConnection;
  zenhubUrl: Scalars['String']['output'];
  zorgMetadata?: Maybe<ZorgIssueMetadata>;
};
...
export type IssueIssueTypeConnection = {
  __typename?: 'IssueIssueTypeConnection';
  /** A list of edges. */
  edges: Array<IssueIssueTypeEdge>;
  /** A list of nodes. */
  nodes: Array<IssueIssueType>;
  /** Information to aid in pagination. */
  pageInfo: PageInfo;
  totalCount: Scalars['Int']['output'];
};

export enum IssueIssueTypeDispositionInput {
  /** Any */
  Any = 'ANY',
  ...
  PlanningPanel = 'PLANNING_PANEL',
  /** Issue types for Planning Panel */
  PlanningPanelOnly = 'PLANNING_PANEL_ONLY'
}

/** An edge in a connection. */
export type IssueIssueTypeEdge = {
  __typename?: 'IssueIssueTypeEdge';
  /** A cursor for use in pagination. */
  cursor: Scalars['String']['output'];
  /** The item at the end of the edge. */
  node?: Maybe<IssueIssueType>;
};
...
export type IssueMetadataPayloadOptionsInput = {
  withAssignees?: InputMaybe<Scalars['Boolean']['input']>;
  withBasicInfo?: InputMaybe<Scalars['Boolean']['input']>;
  withBlockageInfo?: InputMaybe<Scalars['Boolean']['input']>;
  withEpicsInfo?: InputMaybe<Scalars['Boolean']['input']>;
  withEstimates?: InputMaybe<Scalars['Boolean']['input']>;
  withLabels?: InputMaybe<Scalars['Boolean']['input']>;
  withMilestone?: InputMaybe<Scalars['Boolean']['input']>;
  withPipeline?: InputMaybe<Scalars['Boolean']['input']>;
  withPullRequestInfo?: InputMaybe<Scalars['Boolean']['input']>;
  withReleases?: InputMaybe<Scalars['Boolean']['input']>;
  withSprints?: InputMaybe<Scalars['Boolean']['input']>;
};
...
export type IssueSearchFiltersInput = {
  ...
  issueIssueTypeDisposition?: InputMaybe<IssueIssueTypeDispositionInput>;
  issueIssueTypes?: InputMaybe<StringInput>;
  ...
  parentIssues?: InputMaybe<ParentIssuesInput>;
...
export enum IssueTypeDisposition {
  Board = 'BOARD',
  PlanningPanel = 'PLANNING_PANEL'
}

export type IssueTypeOption = BaseIssueType & Timestamps & {
  __typename?: 'IssueTypeOption';
  color?: Maybe<Scalars['String']['output']>;
  createdAt: Scalars['ISO8601DateTime']['output'];
  description?: Maybe<Scalars['String']['output']>;
  disposition: IssueTypeDisposition;
  /** Whether the issue type has related GithubIssueType */
  hasRelatedGithubIssueTypes: Scalars['Boolean']['output'];
  id: Scalars['ID']['output'];
  isDefault: Scalars['Boolean']['output'];
  isDefaultForLevel: Scalars['Boolean']['output'];
  isEnabled: Scalars['Boolean']['output'];
  ...
  relatedGithubIssueTypes: Array<GithubIssueType>;
  updatedAt: Scalars['ISO8601DateTime']['output'];
  /** Underlying Zenhub issue type */
  zenhubIssueType: ZenhubIssueType;
};

/** The connection type for IssueTypeOption. */
export type IssueTypeOptionConnection = {
  __typename?: 'IssueTypeOptionConnection';
  /** A list of edges. */
  edges: Array<IssueTypeOptionEdge>;
  /** A list of nodes. */
  nodes: Array<IssueTypeOption>;
  /** Information to aid in pagination. */
  pageInfo: PageInfo;
  totalCount: Scalars['Int']['output'];
};
...
export type IssueTypeOptionEdge = {
  __typename?: 'IssueTypeOptionEdge';
  /** A cursor for use in pagination. */
  cursor: Scalars['String']['output'];
  /** The item at the end of the edge. */
  node: IssueTypeOption;
};
...
export type IssuesCountCheck = {
  __typename?: 'IssuesCountCheck';
  githubCount: Scalars['Int']['output'];
  raptorCount: Scalars['Int']['output'];
};
...
export type Milestone = GithubTimestamps & Node & Timestamps & {
  ...
  otherRepositories: RepositoryConnection;
  repository: Repository;
...
export type Mutation = {
  ...
  addSubIssues?: Maybe<AddSubIssuesPayload>;
  ...
  createIssueKeyDate?: Maybe<CreateIssueKeyDatePayload>;
  ...
  createTimelineKeyDate?: Maybe<CreateTimelineKeyDatePayload>;
  /** Create a Workspace */
  ...
  deleteIssueKeyDate?: Maybe<DeleteIssueKeyDatePayload>;
  ...
  deleteTimelineKeyDate?: Maybe<DeleteTimelineKeyDatePayload>;
  /** Deletes a Workspace */
  ...
  removeSubIssues?: Maybe<RemoveSubIssuesPayload>;
  ...
  updateIssueKeyDate?: Maybe<UpdateIssueKeyDatePayload>;
  /** Update a milestone */
  ...
  updateTimelineKeyDate?: Maybe<UpdateTimelineKeyDatePayload>;
...
export enum ParentIssueSpecialFilter {
  /** Show issues that are not parents */
  NotAParent = 'not_a_parent',
  /** Show all issues not in parent */
  NotInParent = 'not_in_parent',
  /** Show all parents and hide children */
  ParentsOnly = 'parents_only',
  /** Show all parents and children */
  ParentsWithChildren = 'parents_with_children'
}

/** Filter by parent issue IDs */
export type ParentIssuesInput = {
  ids?: InputMaybe<Array<Scalars['ID']['input']>>;
  recursiveIds?: InputMaybe<Array<Scalars['ID']['input']>>;
  specialFilters?: InputMaybe<ParentIssueSpecialFilter>;
};
...
export type RemoveSubIssuesPayload = {
  __typename?: 'RemoveSubIssuesPayload';
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  failedIssues: Array<Issue>;
  githubErrors: Scalars['JSON']['output'];
...
export type Repository = GithubTimestamps & Node & Timestamps & {
  ...
  assignableIssueTypes: IssueIssueTypeConnection;
  assignableUsers: UserConnection;
  checkIssueCounts?: Maybe<IssuesCountCheck>;
  createdAt: Scalars['ISO8601DateTime']['output'];
  description?: Maybe<Scalars['String']['output']>;
  estimateSet: EstimateSet;
  ghCreatedAt: Scalars['ISO8601DateTime']['output'];
  ...
  ghNodeId?: Maybe<Scalars['ID']['output']>;
  ghUpdatedAt: Scalars['ISO8601DateTime']['output'];
  githubIssueTypes: GithubIssueTypeConnection;
  id: Scalars['ID']['output'];
...
export type ReprioritizeSubIssuePayload = {
  ...
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  githubErrors?: Maybe<Scalars['JSON']['output']>;
...
export type SprintConfigSettings = {
  ...
  withTime?: Maybe<Scalars['Boolean']['output']>;
};
...
export enum SprintIssueOrderField {
  SprintEndAt = 'SPRINT_END_AT'
}

/** Order of Sprint Issue connection */
export type SprintIssueOrderInput = {
  direction?: InputMaybe<OrderDirection>;
  field?: InputMaybe<SprintIssueOrderField>;
};
...
export type StrategicIssueSearchItem = GithubTimestamps & Timestamps & ViewerPermission & {
  __typename?: 'StrategicIssueSearchItem';
  ...
  deliveryRiskStatus?: Maybe<DeliveryRiskStatus>;
  /** @deprecated Use `issue` field instead */
  estimate?: Maybe<Estimate>;
  ghCreatedAt: Scalars['ISO8601DateTime']['output'];
  /** @deprecated Use `issue` field instead */
  ...
  hasMatchingChildren?: Maybe<Scalars['Boolean']['output']>;
  /** @deprecated Use `issue` field instead */
  htmlUrl: Scalars['String']['output'];
  id: Scalars['ID']['output'];
  ...
  parentIssue?: Maybe<Issue>;
  /** Predicted end date */
  predictedEndOn?: Maybe<Scalars['ISO8601DateTime']['output']>;
  /** @deprecated Use `issue` field instead */
  pullRequest: Scalars['Boolean']['output'];
  /** @deprecated Use `issue` field instead */
  pullRequestObject?: Maybe<PullRequest>;
...
export type StrategicIssueSearchItemConnection = {
  __typename?: 'StrategicIssueSearchItemConnection';
  /** A list of edges. */
  edges: Array<StrategicIssueSearchItemEdge>;
  /** A list of nodes. */
  nodes: Array<StrategicIssueSearchItem>;
  /** Information to aid in pagination. */
  pageInfo: PageInfo;
  totalCount: Scalars['Int']['output'];
};
...
export type StrategicIssueSearchItemEdge = {
  __typename?: 'StrategicIssueSearchItemEdge';
  /** A cursor for use in pagination. */
  cursor: Scalars['String']['output'];
  /** The item at the end of the edge. */
  node: StrategicIssueSearchItem;
};

export type StrategicIssuesFiltersInput = {
  /** Filter by delivery risk */
  deliveryRisk?: InputMaybe<DeliveryRiskFilterInput>;
  /** Filter by issue type names */
  issueIssueTypes?: InputMaybe<IssueIssueTypeFiltersInput>;
  /** Filter by issue type level range */
  issueIssueTypesLevelRange?: InputMaybe<IssueIssueTypeLevelRangeInput>;
  /** Filter by label names */
  labels?: InputMaybe<StringInput>;
};

export enum StrategicIssuesOrderField {
...
export type StrategicIssuesOrderInput = {
  direction: OrderDirection;
  field: StrategicIssuesOrderField;
};
...
export type UpdateIssueKeyDatePayload = {
  __typename?: 'UpdateIssueKeyDatePayload';
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  issue: Issue;
  keyDate: KeyDate;
...
export type UpdateTimelineKeyDatePayload = {
  __typename?: 'UpdateTimelineKeyDatePayload';
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  keyDate: KeyDate;
  workspace: Workspace;
...
export type UpdateWorkspaceInput = {
  ...
  assumedEstimateValue?: InputMaybe<Scalars['Int']['input']>;
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  defaultRepositoryGhId?: InputMaybe<Scalars['Int']['input']>;
  description?: InputMaybe<Scalars['String']['input']>;
...
export type Workspace = Timestamps & ViewerPermission & {
  ...
  assumedEstimateValue?: Maybe<Scalars['Int']['output']>;
  ...
  sprints: SprintConnection;
  timelineKeyDates?: Maybe<KeyDateConnection>;
...
export type ZenhubIssueTypeConnection = {
  __typename?: 'ZenhubIssueTypeConnection';
  /** A list of edges. */
  edges: Array<ZenhubIssueTypeEdge>;
  /** A list of nodes. */
  nodes: Array<ZenhubIssueType>;
  /** Information to aid in pagination. */
  pageInfo: PageInfo;
  totalCount: Scalars['Int']['output'];
};
...
export type ZenhubIssueTypeEdge = {
  __typename?: 'ZenhubIssueTypeEdge';
  /** A cursor for use in pagination. */
  cursor: Scalars['String']['output'];
  /** The item at the end of the edge. */
  node: ZenhubIssueType;
};
...
export type ZenhubOrganization = Node & Timestamps & {
  ...
  id: Scalars['ID']['output'];
  issueTypeOptions: IssueTypeOptionConnection;
  name?: Maybe<Scalars['String']['output']>;
  projects: ProjectConnection;
  roadmapItems: RoadmapItemConnection;
  /** Search and filter issues for planning panel */
  searchStrategicIssues: StrategicIssueSearchItemConnection;
  updatedAt: Scalars['ISO8601DateTime']['output'];
  workspaces: WorkspaceConnection;
  zenhubIssueTypes: ZenhubIssueTypeConnection;
  zenhubLabels: ZenhubLabelConnection;
...
export type ZorgIssueMetadataInput = {
  ...
  "possibleTypes": {
    ...
    "Node": [
      ...
      "ZenhubLabel",
      "ZenhubOrganization",
      "ZenhubOrganizationLimited",
      "ZenhubUser",
      "ZenhubUserAtOrganization"
    ],
    "Owner": [
      "Bot",
      "Mannequin",
    ...
    "Timestamps": [
      ...
      "WorkspaceFavorite",
      "WorkspaceRepository",
      "WorkspaceSharedZenhubRepository",
      "ZenhubEpic",
      "ZenhubIssueType",
      "ZenhubLabel",
      "ZenhubOrganization",
